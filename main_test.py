    ...
    if st.session_state["contexto_pdf"]:  # Documentos extras prompt
        if st.button("📊 Analisar PDF e gerar planilha de Documentos Extras"):
            with st.spinner("Analisando o edital e gerando a planilha..."):
                ...
                **todos os documentos os solicitados que não constam na lista abaixo** (ex: Registro, Certificado,
                ANEXO II) listados em Credenciamento, Habilitação, Outros Documentos ou Anexos O objetivo é garantir 
                que nenhum requisito seja perdido.
                ...
                **Instruções para a Resposta:**
                ...
                2.  Para cada documento encontrado que não está na lista acima, extraia as seguintes informações:
                    ...
                    no Anexo III").
                4.  Colete todos os documentos mesmo que pareça redundante ou irrelevante 
                (ex: ANEXO III – MODELO DE DECLARAÇÃO UNIFICADA)
